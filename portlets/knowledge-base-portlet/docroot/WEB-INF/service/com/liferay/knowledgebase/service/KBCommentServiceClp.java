 ...
 */
@ProviderType
public class KBCommentServiceClp implements KBCommentService {
	public KBCommentServiceClp(InvokableService invokableService) {
		_invokableService = invokableService;

		_methodName0 = "deleteKBComment";

		_methodParameterTypes0 = new String[] {
				"com.liferay.knowledgebase.model.KBComment"
			};

		_methodName1 = "deleteKBComment";
	...
	public com.liferay.knowledgebase.model.KBComment deleteKBComment(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { kbCommentId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
