 ...
 * @author Tina Tian
 */
public class MicroblogsSampleSQLBuilder {
	...
	public static void main(String[] args) {
		...
		try {
			...
			DataFactory dataFactory = new MicroblogsDataFactory(properties);

			new MicroblogsSampleSQLBuilder(properties, dataFactory);
		}
		catch (Exception e) {
			e.printStackTrace();
		}
	...
	public MicroblogsSampleSQLBuilder(
		...
		properties.put("sample.sql.output.csv.file.names", "microblogs");
		properties.put(
			"sample.sql.script", "com/liferay/microblogs/tools/microblogs.ftl");
